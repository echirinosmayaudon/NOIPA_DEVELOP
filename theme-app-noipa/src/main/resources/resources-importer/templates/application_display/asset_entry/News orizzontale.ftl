...
<#if entries?has_content>
	<#list entries as curEntry>
        ...
        <#assign sizeAbs = abstract?length />
	...
	<div class="mx-1 card bg-white shadow ml-1 ml-md-4 mb-5">
						...
						<div class="col-sm-6 py-4">
							...
							<#if category?has_content>
								...
								<div class="news-div h-150p pr-4">
									...
									<#if sizeAbs < 80 >
									    <p>${abstract} - ${sizeAbs}</p>
									<#else>
									    <#assign subabstract = abstract[0..80] />
									     <p>${subabstract} ... </p>
									</#if>
								</div>
								<p class="py-2">
        ...
        <#else>
<div class="py-4 px-4 mx-1 card bg-white shadow mb-5">
	<div class="text-link text-uppercase font-weight-300">
		<#if category?has_content>
			<#list category as cat>
			<div class="text-link text-uppercase font-weight-300 ">${cat.getName()}
			</div>
	...
	<a href="dettaglio-news/-/asset_publisher/GBFi2ZJ8I37i/content/${journalArticle.getUrlTitle()}" class="font-weight-300 text-16p">Leggi di più<i class="fa fa-arrow-right ml-3" aria-hidden="true"></i></a>
</div>
        </#if>
