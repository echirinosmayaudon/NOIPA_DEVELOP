	...
	<#list entries as curEntry>
		...
		<a href="${linkVideo}" class="link-video"><img src="${immagine}" alt="" class="img-fluid w-100"></a>
						...
						<div class="col-sm-7">
							...
							<a href="#" class="btn btn-default bg-transparent btn-lg mb-4 px-5 mr-3 text-16p">Enti Terzi</a>
							<a href="#" class="btn btn-default bg-transparent btn-lg mb-4 px-5 mr-3 text-16p">Partner Istituzionali</a>
						</div>
					</div>
				</div>
