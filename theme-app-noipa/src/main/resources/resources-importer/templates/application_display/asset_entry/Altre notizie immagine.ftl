...
<a href="dettaglio-news/-/asset_publisher/GBFi2ZJ8I37i/content/${journalArticle.getUrlTitle()}" class="font-weight-300 text-16p">Lorem Ipsum<i class="fa fa-arrow-right ml-3" aria-hidden="true"></i></a>
				</div>
			</div>
			
			<div class="text-center pb-4">
				<span class="d-block">Vedi altre notizie di</span>
							<#if category?has_content>
                                <#list category as cat_altre>
				<a href="#" class="btn btn-default bg-transparent btn-lg my-2 px-5 text-16p py-1">${cat_altre.getName()}</a>
                                </#list>
                            </#if>
			</div>
