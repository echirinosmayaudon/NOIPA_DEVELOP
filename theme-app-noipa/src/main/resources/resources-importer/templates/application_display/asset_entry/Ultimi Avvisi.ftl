...
-->
				<div class="mb-5">
					<h3 class="mb-4 py-0 text-primary-dark text-32p ">Ultimo avviso</h3>
<#if entries?has_content>
    ...
    <a href="#" class="border border-link rounded-13 px-5 py-0 text-16p mr-2 mb-2 d-inline-block line-height-20p">${tag.name}</a>
					...
					<div class="text-center">
						<a href="/web/guest/avvisi" class="btn btn-default bg-transparent btn-lg my-4 px-5 text-16p py-1">Avvisi</a>
					</div>
