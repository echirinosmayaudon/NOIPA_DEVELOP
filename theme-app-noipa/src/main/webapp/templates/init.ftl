...
<#assign
	css_folder_noipa = css_folder + "/noipa/"
	font_folder_noipa = css_folder_noipa + "/font/"
	javascript_folder_noipa = javascript_folder + "/noipa/"
	images_folder_noipa = images_folder + "/noipa/"
/>
...
<#if currentURL?contains("/cl")>
	<#assign currentURL = currentURL?keep_after("/cl") />
</#if>


<#if currentURL?contains("/en")>
	<#assign currentURL = currentURL?keep_after("/en") />
</#if>

<#if currentURL?contains("/de")>
	<#assign currentURL = currentURL?keep_after("/de") />
</#if>

<#if currentURL?contains("/it")>
	<#assign currentURL = currentURL?keep_after("/it") />
</#if>
...
<#assign 
	company_url_search = company_url?keep_after("/web/guest")>
	
	
<#if currentURL == "/">
	<#assign 
		company_url_search = company_url+"/home-page">
<#else>
	<#assign 
		company_url_search = company_url?keep_after("/web/guest")+currentURL>
