<div class="noipa-layout-app-2" id="main-content" role="main">
	...
	<div class="portlet-layout row">
		...
		<div class="portlet-column portlet-column-last col-md-1" id="column-3">
	...
	<div class="portlet-layout row">
		...
		<div class="portlet-column col-md-5" id="column-6">
			$processor.processColumn("column-6", "portlet-column-content")
		</div>

		<div class="portlet-column col-md-5" id="column-7">
			$processor.processColumn("column-7", "portlet-column-content")
		</div>

		<div class="portlet-column portlet-column-last col-md-1" id="column-8">
