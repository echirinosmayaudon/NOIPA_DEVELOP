...
/**
 * Provides the local service interface for EntiAmministrazione. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EntiAmministrazioneLocalServiceUtil
...
public interface EntiAmministrazioneLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EntiAmministrazioneLocalServiceUtil} to access the EntiAmministrazione local service. Add custom service methods to {@link it.gov.mef.opendata.webformassistenza.service.impl.EntiAmministrazioneLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public EntiAmministrazione addEntiAmministrazione(
	...
	*/
	...
	public EntiAmministrazione createEntiAmministrazione(long entiId);
	...
	*/
	...
	public EntiAmministrazione deleteEntiAmministrazione(
		EntiAmministrazione entiAmministrazione);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public EntiAmministrazione deleteEntiAmministrazione(long entiId)
	...
	*/
	...
	public EntiAmministrazione fetchEntiAmministrazione(long entiId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EntiAmministrazione getEntiAmministrazione(long entiId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<EntiAmministrazione> getEntiAmministraziones(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public EntiAmministrazione updateEntiAmministrazione(
		EntiAmministrazione entiAmministrazione);
}